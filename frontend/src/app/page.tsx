  ...
  return (
    <>
      ...
      >
        ...
        <div className="py-12">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl italic text-white font-semibold text-center mb-8">
              Special Offers
            </h2>
      ...
      <footer className=" footer bg-zinc-50 text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left m-0 p-0">
        <div className="flex flex-col lg:flex-row items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-white/10 lg:justify-between">
          ...
          <div className="flex justify-center lg:justify-start">
            ...
            <a href="#!" className="me-6 h-6 w-6 hover:text-blue-500">
              <FaFacebook size={28} />
            </a>
            <a href="#!" className="me-6 h-6 w-6 hover:text-blue-400">
              <FaTwitter size={28} />
            </a>
            <a href="#!" className="me-6 h-6 w-6 hover:text-pink-500">
              <FaInstagram size={28} />
            </a>
            <a href="#!" className="me-6 h-6 w-6 hover:text-blue-700">
              <FaLinkedin size={28} />
            </a>
          </div>
        </div>

        {/* Air Elegance Information */}
        <div className="flex flex-col lg:items-start lg:ml-10 space-y-4 justify-start">
          <div className="max-w-prose">
            <h6 className="mb-2 flex font-semibold uppercase md:justify-start">
              <span className="me-1">
                <FaPlane size={24} />
              </span>
              Air Elegance
        ...
        <div className="flex flex-col lg:items-end lg:pr-10 space-y-4 justify-center">
          ...
          <div className="flex flex-col items-start">
            <div className="flex items-center mb-4">
              ...
              <span>Luxaria Business Hub, Surat</span>
            </div>
            <div className="flex items-center mb-4">
              <FaEnvelope className="me-2" size={26} />
              <span>info@airelegance.com</span>
            </div>
