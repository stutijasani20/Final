...
// // // // //               </Typography>
// // // // //               <Typography variant="body1" className="mb-2">
// // // // //                 <strong>Departure Time:</strong> {new Date(selectedFlight.departure_time).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false })}
// // // // //               </Typography>
// // // // //               <Typography variant="body1" className="mb-2">
// // // // //                 <strong>Arrival Airport:</strong> {selectedFlight.arrival_airport_name} ({selectedFlight.arrival_code})
// // // // //               </Typography>
// // // // //               <Typography variant="body1" className="mb-2">
// // // // //                 <strong>Arrival Time:</strong> {new Date(selectedFlight.arrival_time).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false })}
// // // // //               </Typography>
// // // // //               <Typography variant="body1" className="mb-2">
...
// // //                 <Typography variant="body1" className="mb-2">
// // //                   <strong>Total Duration:</strong> {calculateDuration(flight.departure_time, flight.arrival_time)}
// // //                 </Typography>
// // //               </div>
// // //               <div className="flex justify-between mt-4">
// // //                 <Button
