...
//               />
//               <p style={{ color: 'grey', fontStyle: 'italic', paddingRight: '150px', fontSize: '0.8em' }}>Hint: Email Should have "@" and Should Verified account.</p>
//             </div>
...
//               />
//               <p style={{ color: 'lightgrey', fontStyle: 'italic', paddingRight: '175px', fontSize: '0.8em' }}>Hint: Password Should be Have atleasr 8 Character!!</p>
//             </div>
...
//               />
//               <p style={{ color: 'lightgrey', fontStyle: 'italic', paddingRight: '280px', fontSize: '0.8em' }}>Hint: Password be Same as Above!!</p>
//             </div>
